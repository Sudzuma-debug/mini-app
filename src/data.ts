...
export const SERVICES: Service[] = [
  {
    ...
    duration: 45,
    price: 1800,
    description: 'Классика или современный фасон под форму лица',
    category: 'hair',
  },
  {
    id: 'fade',
    ...
    duration: 50,
    price: 2000,
    description: 'Чистые переходы, точная геометрия линий',
    category: 'hair',
  },
  {
    id: 'beard',
    ...
    duration: 30,
    price: 1200,
    description: 'Моделирование контура и уход за щетиной',
    category: 'beard',
  },
  {
    id: 'royal',
    ...
    duration: 75,
    price: 3200,
    description: 'Стрижка + борода + горячее полотенце',
    category: 'combo',
  },
  {
    id: 'father',
    ...
    duration: 70,
    price: 2800,
    description: 'Две стрижки в одном визите',
    category: 'combo',
  },
  {
    id: 'care',
    ...
    duration: 25,
    price: 900,
    description: 'Маска, укладка и рекомендации по уходу',
    category: 'care',
  },
]
...
export const LOYALTY = {
  ...
  visits: 18,
  history: [
    { id: '1', title: 'Королевский сет', points: 160, date: '12 июл' },
